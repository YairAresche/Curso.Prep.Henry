...
function mayoriaDeEdad(edad) {
  ...
  // let valor = edad > 18 ? "Allowed": "Not allowed";
...
function saludo(idioma) {
  ...
  // Tu código:
  let valor = idioma === "aleman" ? "Guten Tag!":
...
function fizzBuzz(numero) {
  ...
  let valor = numero % 15 === 0 ? "fizzbuzz":
              numero % 3 === 0 ? "fizz":
              numero % 5 === 0 ? "buzz":
              numero;
  return valor;        
...
function esVerdadero(valor){
  ...
  let booleano = valor === true ? "Soy verdadero": "Soy falso";
  return booleano;
}
